 ...
 */
final class Version20260418201404 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events ADD status VARCHAR(50) DEFAULT \'en_attente\' NOT NULL, DROP statut');
        ...
        $this->addSql('ALTER TABLE place_images CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, ADD PRIMARY KEY (id)');
        ...
        $this->addSql('ALTER TABLE places CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE host_id host_id CHAR(36) NOT NULL, CHANGE description description LONGTEXT DEFAULT NULL, CHANGE status status VARCHAR(20) DEFAULT \'PENDING\' NOT NULL, CHANGE created_at created_at DATETIME NOT NULL, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE events ADD statut VARCHAR(20) NOT NULL, DROP status');
        ...
        $this->addSql('ALTER TABLE places MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE places CHANGE id id INT NOT NULL, CHANGE description description TEXT DEFAULT NULL, CHANGE status status ENUM(\'PENDING\', \'APPROVED\', \'DENIED\') DEFAULT \'PENDING\', CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, CHANGE host_id host_id VARCHAR(36) NOT NULL, DROP PRIMARY KEY');
        ...
        $this->addSql('ALTER TABLE place_images MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE place_images CHANGE id id INT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT CURRENT_TIMESTAMP, DROP PRIMARY KEY');
